(function(angular) {
	...
	var HomepageController = function($scope, $state, $window, $rootScope, $stateParams, userService) {	
	...
	//app.controller('HomepageCtrl', ['$scope', '$state', '$window', '$rootScope', '$stateParams', 'userService',
		...
		function getUsers() {
			...
			.success(function(response) {
				$window.alert("Response in service." + response);
	...
	HomepageController.$inject = ['$scope', '$state', '$window', '$rootScope', '$stateParams', 'userService'];
	app.controller('HomepageCtrl', HomepageController);
